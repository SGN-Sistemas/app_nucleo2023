...
import Home from "./src/components/navigationIndependent/home";
import { AuthContext } from "./src/contexts/ContextApi";

// import ChangeLogin from "./src/components/changeLogin";
...
const App = () => {
  ...
  const [atualizaResp, setAtualizaResp] = useState(false);
